...
export default function ResponsibilityQRDialog({
  children,
  assetId,
  assetName,
  inventoryNumber,
          ...
          {isLoading ? (
            ...
            >
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center w-full px-3">
                ...
                <p className="text-[11px] font-extrabold text-black text-center max-w-[220px] mx-auto leading-tight mt-1 break-words">
